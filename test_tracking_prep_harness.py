...
# ── subprocess/os 束縛検証は ast_policy_helpers へ移設（AST-CONSOL 票・
# 挙動同一の移設のみ。凍結コピー _prev の対照契約も共通 module 側で不変維持）──
from ast_policy_helpers import (_proc_binding_violations,
                                _proc_binding_violations_prev)
