...
# 見本（票由来・匿名化済み・改変禁止）。ラベルはプロンプト表示用
...
STYLE_EXEMPLARS_NOTE = (
    ...
    "見本の中の数値・期間・固有名詞（○○・△△・◯社・5年程度・1ヶ月程度・"
    "住宅ローン等）と法的見立ての中身は見本から引用しない。回答に金額・期間・"
    "見立てを入れるときは、必ず本プロンプトの弁護士確定定型・FAQ・顧客情報を"
    "出典とする。見本の名乗り（「弁護士の大野と申します」）も引用しない"
    "（弁護士本人として名乗らない。対応者についてはFAQの回答のとおり）。"
)
