...
- 営業案内・アクセス: やり取りはすべてこのLINEで完結し、メッセージは24時間いつでも送信できる（内容確認の上、順次返信する）。この一般案内は自動送信可。事務所の固有情報（営業時間・所在地・最寄り駅からのアクセス・電話番号）はこの記録に登録されていないため、創作せず承認制（カテゴリ「営業案内・アクセス」、auto_send=false）に回す。
