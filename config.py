...
EXPECTED_DOCX_TEMPLATES = {
    ...
    # hub/houki_contract.py（HOUKI-CONTRACT-GEN 相続放棄 委任契約書）が差し込む 12 キー
    # （人承認済み確定 v1・2026-09-06。各キーは雛形にちょうど 1 回・単一 run。
    # {{特約}} は apply_tokuyaku・{{申述人一覧}} は expand_applicants が専用処理）
    "docx_templates/houki/委任契約書.docx": [
